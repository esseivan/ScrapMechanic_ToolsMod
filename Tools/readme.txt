...
If you want to use the auto installer, open the "auto_install.exe" app in the "AdvancedReadme/AutoInstaller" folder
	With this app, it will replace the files by he ones in the "AdvancedReadme/Data" folder
	You can also create and restore backup (create before installing)
